...
document.addEventListener('DOMContentLoaded', () => {
    const nodesPageData = [
        ...
        { host: 'br4-ccdemo-svr1', port: '9600', ip: '10.0.20.19', status: 'Shut Down', type: 'HAProxy', role: 'None', badge: null, cluster: 'MariaDB (ID:21)', clusterLogo: '<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline>', version: '2.8.16', seen: 'in 4 minutes' },
        { host: 'br4-ccdemo-svr2', port: '9600', ip: '10.0.20.20', status: 'Shut Down', type: 'HAProxy', role: 'None', badge: null, cluster: 'MariaDB (ID:21)', clusterLogo: '<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline>', version: '2.8.16', seen: 'in 4 minutes' },
