...
# Update Left Sidebar in Changelog for v1.4.6
...
if old_sidebar in html:
    ...
    print("Updated Left Sidebar with v1.4.6 (Latest)")

# Update TOC for v1.4.6
...
if old_toc in html:
    ...
    print("Updated TOC with v1.4.6 Release")

# Update Middle Content for v1.4.6
old_content_top = """                    <h2 id="v1-4-5" style="color: #4b5563; font-weight: 300; font-size: 1.8rem; margin-bottom: 20px; border-top: 1px solid #e5e7eb; padding-top: 32px;">v1.4.5</h2>
...
new_content_top = """                    <h2 id="v1-4-6" style="color: #4b5563; font-weight: 300; font-size: 1.8rem; margin-bottom: 20px; border-top: 1px solid #e5e7eb; padding-top: 32px;">v1.4.6</h2>
                    ...
                    <h2 id="v1-4-5" style="color: #4b5563; font-weight: 300; font-size: 1.8rem; margin-bottom: 20px; border-top: 1px solid #e5e7eb; padding-top: 32px;">v1.4.5</h2>
                    <ul style="color: #4b5563; line-height: 1.7; padding-left: 20px; margin-bottom: 40px;">
                        <li><span style="font-weight: 600;">Fix (Sunucu Yönetim Dashboard):</span> Backend metrik toplayıcısında (<code>ha_manager.py</code>) PostgreSQL veritabanı istatistiklerinin çekilmesi sırasında oluşan değişken atama hatası (<code>NameError: tup_fetched</code>) giderildi. Ana Sunucu (Master) ve Yedek Sunucu (Standby) için Ağ Gecikmesi (Ping: ~310ms), Depolama (9 MB), Aktif Bağlantılar, Önbellek Başarısı (%100) ve Ana Tablo Kayıtları (6 Kayıt - vehicles) gerçek zamanlı olarak bağlandı.</li>
                    </ul>"""
...
if old_content_top in html:
    ...
    print("Updated Middle Content with v1.4.6")

# Bump asset version to v=53
html = html.replace('v=52', 'v=53')
...
js = js.replace("changelogAnchors = ['v1-4-5', 'v1-4-4', 'v1-4-3', 'v1-4-2', 'v1-4-1', 'release-cycle', 'whats-new'];", "changelogAnchors = ['v1-4-6', 'v1-4-5', 'v1-4-4', 'v1-4-3', 'v1-4-2', 'v1-4-1', 'release-cycle', 'whats-new'];")
js = js.replace('v=52', 'v=53')

with open('fastapi_app/static/main.js', 'w', encoding='utf-8') as f:
    f.write(js)

print("Updated main.js with v1.4.6 anchor and v=53")
